...
var Tokenizer = (function () {
    ...
    Tokenizer.prototype.tryToOpenMedia = function () {
        ...
        return this.mediaConventions.some(function (media) {
            return _this.tryToOpenConvention({
                ...
                then: function () {
                    _this.addTokenAfterFlushingBufferToPlainTextToken(media.startTokenKind);
                }
            });
        });
    };
    ...
    Tokenizer.prototype.tryToOpenRichSandwich = function (sandwich) {
        ...
        return this.tryToOpenConvention({
            ...
            then: function () {
                _this.addTokenAfterFlushingBufferToPlainTextToken(sandwich.startTokenKind);
            }
        });
    };
    ...
    Tokenizer.prototype.tryToTokenizeRaisedVoicePlaceholders = function () {
        ...
        return this.consumer.advanceAfterMatch({
            ...
            then: function (asterisks, isTouchingWordEnd, isTouchingWordStart) {
                ...
                _this.addTokenAfterFlushingBufferToPlainTextToken(asteriskTokenKind, asterisks);
            }
        });
    };
