...
describe("Both inline revealables and revealable blocks", () => {
  it("have sequential IDs", () => {
    ...
    const html =
      '<div class="up-revealable"><label for="up-revealable-1" role="button">reveal</label><input id="up-revealable-1" type="checkbox">'
      + '<div role="alert">'
      + '<p>The main character defeats the bad guy.</p>'
      + '<div class="up-revealable"><label for="up-revealable-2" role="button">reveal</label><input id="up-revealable-2" type="checkbox">'
      + '<div role="alert">'
      + '<p>'
      + 'The hero was unambiguously '
      + '<span class="up-revealable">'
      + '<label for="up-revealable-3" role="button">reveal</label>'
      + '<input id="up-revealable-3" type="checkbox">'
      + '<span role="alert">'
      + 'good '
      + '<span class="up-revealable">'
      + '<label for="up-revealable-4" role="button">reveal</label>'
      + '<input id="up-revealable-4" type="checkbox">'
      + '<span role="alert">'
      + 'and righteous.'
      + '</span>'
      + '</span>'
      ...
      + '</div>'
      + '</div>'
      + '<div class="up-revealable"><label for="up-revealable-5" role="button">reveal</label><input id="up-revealable-5" type="checkbox">'
      + '<div role="alert">'
