...
describe("Both inline revealables and revealable blocks", () => {
  it("have sequential IDs", () => {
    ...
    const html =
      ...
      + '<div class="up-revealable"><label for="up-revealable-2" role="button" tabindex="0">reveal</label><input id="up-revealable-2" type="checkbox">'
      + '<div role="alert">'
      + '<p>'
      + 'The hero was unambiguously '
      + '<span class="up-revealable">'
      + '<label for="up-revealable-3" role="button" tabindex="0">reveal</label>'
      + '<input id="up-revealable-3" type="checkbox">'
      + '<span role="alert">'
      + 'good '
      + '<span class="up-revealable">'
      + '<label for="up-revealable-4" role="button" tabindex="0">reveal</label>'
      ...
      + '</div>'
      + '</div>'
      + '<div class="up-revealable"><label for="up-revealable-5" role="button" tabindex="0">reveal</label><input id="up-revealable-5" type="checkbox">'
      + '<div role="alert">'
