...
describe("Both inline revealables and revealable blocks", () => {
  it("have sequential IDs", () => {
    ...
    const html =
      ...
      + '<label for="up-revealable-4" role="button" tabindex="0">toggle visibility</label>'
      + '<span role="alert">'
      + 'and righteous.'
      + '</span>'
      + '</span>'
      ...
      + '</div>'
      + '<div class="up-revealable">'
      + '<input id="up-revealable-5" type="checkbox">'
      + '<label for="up-revealable-5" role="button" tabindex="0">toggle visibility</label>'
      + '<div role="alert">'
