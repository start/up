...
context("Within the table of contents itself", () => {
  specify('the IDs of revealable content elements do not clash with those in the document', () => {
    ...
    expect(tableOfContentsHtml).to.equal(
      ...
      + '<input id="up-toc-revealable-1" type="checkbox">'
      + '<label for="up-toc-revealable-1" role="button" tabindex="0">toggle visibility</label>'
      ...
      + 'I enjoy grapes '
      + '<span class="up-revealable">'
      + '<input id="up-toc-revealable-2" type="checkbox">'
      + '<label for="up-toc-revealable-2" role="button" tabindex="0">toggle visibility</label>'
    ...
    expect(documentHtml).to.equal(
      ...
      + 'I enjoy apples '
      + '<span class="up-revealable">'
      + '<input id="up-revealable-2" type="checkbox">'
      + '<label for="up-revealable-2" role="button" tabindex="0">toggle visibility</label>'
      + '<span role="alert">sometimes</span>'
      + '</span>'
      + '</h1>'
      + '<h1 id="up-topic-2">'
      ...
      + '<label for="up-revealable-3" role="button" tabindex="0">toggle visibility</label>'
      + '<span role="alert">usually</span>'
      + '</span>'
      + '</h1>')
  })
