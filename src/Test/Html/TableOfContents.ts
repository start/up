...
context("Within the table of contents itself", () => {
  specify('the IDs of revealable content elements do not clash with those in the document', () => {
    ...
    expect(tableOfContentsHtml).to.equal(
      ...
      + '<label for="up-toc-revealable-1" role="button" tabindex="0">reveal</label>'
      ...
      + '<label for="up-toc-revealable-2" role="button" tabindex="0">reveal</label>'
    ...
    expect(documentHtml).to.equal(
      ...
      + '<label for="up-revealable-2" role="button" tabindex="0">reveal</label>'
      + '<span role="alert">sometimes</span>'
      + '</span>'
      + '</h1>'
      + '<h1 id="up-topic-2">'
