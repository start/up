...
context("Within the table of contents itself", () => {
  specify('the IDs of revealable content elements do not clash with those in the document', () => {
    ...
    expect(tableOfContentsHtml).to.equal(
      ...
      + '<label for="up-toc-revealable-1" role="button">reveal</label>'
      ...
      + 'I enjoy grapes '
      + '<span class="up-revealable">'
      + '<label for="up-toc-revealable-2" role="button">reveal</label>'
    ...
    expect(documentHtml).to.equal(
      ...
      + 'I enjoy apples '
      + '<span class="up-revealable">'
      + '<label for="up-revealable-2" role="button">reveal</label>'
