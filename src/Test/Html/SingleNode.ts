...
describe('A level 1 heading node', () => {
  it('renders an <h1> element', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Bulbasaur')], { level: 1, searchableMarkup: NOT_USED })
    ])
...
describe('A level 2 heading node', () => {
  it('renders an <h2> element', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Ivysaur')], { level: 2, searchableMarkup: NOT_USED })
    ])
...
describe('A level 3 heading node', () => {
  it('renders an <h3> element', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Venusaur')], { level: 3, searchableMarkup: NOT_USED })
    ])
...
describe('A level 4 heading node', () => {
  it('renders an <h4> element', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Charmander')], { level: 4, searchableMarkup: NOT_USED })
    ])
...
describe('A level 5 heading node', () => {
  it('renders an <h5> element', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Charmeleon')], { level: 5, searchableMarkup: NOT_USED })
    ])
...
describe('A level 6 heading node', () => {
  it('renders an <h6> element', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Charizard')], { level: 6, searchableMarkup: NOT_USED })
    ])
...
context('Headings with levels 7 and up render as <div role="heading"> elements with an "aria-level" attribute equal to their level:', () => {
  specify('Level 7', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Squirtle')], { level: 7, searchableMarkup: NOT_USED })
    ])
  ...
  specify('Level 8', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Squirtle')], { level: 8, searchableMarkup: NOT_USED })
    ])
  ...
  specify('Level 9', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Squirtle')], { level: 9, searchableMarkup: NOT_USED })
    ])
  ...
  specify('Level 10', () => {
    const document = new Up.Document([
      new Up.Heading([new Up.Text('Squirtle')], { level: 10, searchableMarkup: NOT_USED })
    ])
...
describe('A section link node that is associated with a table of contents entry', () => {
  it("renders a link to the entry in the document", () => {
    ...
    ], { level: 1, searchableMarkup: NOT_USED, ordinalInTableOfContents: 1 })
