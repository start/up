...
context('When a table of contents has multiple entries', () => {
  specify('the ID of each element referenced by the table of contents ends with a number corresponding to its ordinal (1-based) in the table of contents', () => {
    ...
    expect(Up.toHtml(documentNode)).to.be.eql(
      ...
      + '<ul>'
      + '<li><h2><a href="#up-part-1">The best fruit</a></h2></li>'
      + '<li><a href="#up-part-2">Apple varieties</a></li>'
      + '<li><h3><a href="#up-part-3">Purchasing</a></h3></li>'
      + '<li><a href="#up-part-4">Where to buy apples</a></li>'
      + '</ul>'
      + '</nav>'
      + '<h1 id="up-part-1">The best fruit</h1>'
      + '<ul>'
      + '<li>'
      + '<ol>'
      + '<li>'
