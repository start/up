...
context('When an outline syntax node has a source line number, its outermost element is given an "data-up-source-line" attribute whose value is the line number. This is true for:', () => {
  specify('Paragraphs', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<p data-up-source-line="5">Nimble navigator</p>')
  })
  ...
  specify('Code blocks', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<pre data-up-source-line="3"><code>color = Color.Green</code></pre>')
  })
  ...
  specify('Level 1 headings', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<h1 data-up-source-line="3">Bulbasaur</h1>')
  })
  ...
  specify('Level 2 headings', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<h2 data-up-source-line="1">Bulbasaur</h2>')
  })
  ...
  specify('Level 3 headings', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<h3 data-up-source-line="3">Bulbasaur</h3>')
  })
  ...
  specify('Level 4  headings', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<h4 data-up-source-line="1">Bulbasaur</h4>')
  })
  specify('Level 5 headings', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<h5 data-up-source-line="3">Bulbasaur</h5>')
  })
  ...
  specify('Level 6 headings', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<h6 data-up-source-line="1">Bulbasaur</h6>')
  })
  ...
  specify('Level 10 headings', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<h6 data-up-source-line="2">Bulbasaur</h6>')
  })
  ...
  specify('Thematic breaks', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<hr data-up-source-line="2">')
  })
