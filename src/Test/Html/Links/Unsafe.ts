...
context('By default, links with unsafe schemes produce no <a> elements. Instead, their contents are included directly into their outer element. These unsafe URL schemes are:', () => {
  specify('javascript', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<p>Click me!</p>')
  })
...
context('Though by default, links with unsafe schemes produce no HTML, link URLs can contain unsafe schemes:', () => {
  specify('javascript', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<p><a href="https://google.com/?q=javascript:malicious">Click me!</a></p>')
  })
  ...
  specify('data', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<p><a href="https://google.com/?q=data:malicious">Click me!</a></p>')
  })
  ...
  specify('file', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<p><a href="https://google.com/?q=file:malicious">Click me!</a></p>')
  })
  ...
  specify('vbscript', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<p><a href="https://google.com/?q=vbscript:malicious">Click me!</a></p>')
  })
})
...
describe('By default, a safe link nested inside an unsafe link', () => {
  it('produces an <a> element', () => {
    ...
    expect(Up.renderHtml(document)).to.equal('<p><a href="https://google.com">Click me!</a></p>')
  })
})
