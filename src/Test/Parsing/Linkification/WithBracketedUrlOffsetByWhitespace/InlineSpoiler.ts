...
context('A linkified spoiler can have whitespace between itself and its bracketed URL, but only if the URL satisfies one of the following conditions:', () => {
  ...
  context('When the URL has a scheme', () => {
    ...
    specify('the URL must not contain any spaces', () => {
      expect(Up.parseDocument('[SPOILER: something terrible] (https://stackoverflow.com is nice)')).to.deep.equal(
    ...
    specify('there must be somethng after the scheme', () => {
      expect(Up.parseDocument('[SPOILER: email] (mailto:)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('email')
          ]),
    ...
    specify('there must be somethng after the scheme beyond only slashes', () => {
      expect(Up.parseDocument('[SPOILER: local files] (file:///)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
    ...
    specify('the scheme must not be escaped', () => {
      expect(Up.parseDocument('[SPOILER: email] (\\mailto:daniel@wants.email)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('email')
          ]),
  ...
  describe('When the URL starts with a slash, the URL', () => {
    it('must not contain any spaces', () => {
      expect(Up.parseDocument('[SPOILER: something terrible] (/r9k/ created it)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('something terrible')
          ]),
    ...
    it('must have something after the slash', () => {
      expect(Up.parseDocument('[SPOILER: slash] (/)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('slash')
          ]),
    ...
    it('must not have its slash escaped', () => {
      expect(Up.parseDocument('[SPOILER: yeah] (\\/r9k/)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('yeah')
          ]),
  ...
  describe('When the URL starts with a hash mark ("#"), the URL', () => {
    ...
    it('must have something after the hash mark', () => {
      expect(Up.parseDocument('[SPOILER: hash mark] (#)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
    ...
    it('must not contain any spaces', () => {
      expect(Up.parseDocument('[SPOILER: something terrible] (#starcraft2 was never trending)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('something terrible')
          ]),
    ...
    it('must not have its hashmark escaped', () => {
      expect(Up.parseDocument('[SPOILER: yeah] (\\#starcraft2)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('yeah')
          ]),
  ...
  describe('When the URL merely has a subdomain and a top-level domain', () => {
    ...
    specify('the top-level domain may not be followed by any character other than a forward slash', () => {
      expect(Up.parseDocument('[SPOILER: that place] (4chan.org-terrifying)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
    ...
    context('The top-level domain must contain only letters', () => {
      specify('No numbers', () => {
        expect(Up.parseDocument('[SPOILER: username] (john.e.smith5)')).to.deep.equal(
          insideDocumentAndParagraph([
            new InlineSpoiler([
      ...
      specify('No hyphens', () => {
        expect(Up.parseDocument('[SPOILER: username] (john.e.smith-kline)')).to.deep.equal(
          insideDocumentAndParagraph([
            new InlineSpoiler([
              new PlainText('username')
            ]),
    ...
    specify('the URL must start with a letter or a number, not a period', () => {
      expect(Up.parseDocument('[SPOILER: top-level domain] (.co.uk)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
    ...
    specify('the URL must not have consecutive periods before the top-level domain', () => {
      expect(Up.parseDocument('[SPOILER: Ash is not his own father] (um..uh)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
    ...
    specify('the URL must not have consecutive periods directly after the top-level domain before the slash that indicates the start of the resource path', () => {
      expect(Up.parseDocument('[SPOILER: debilitating sadness] (4chan.org../r9k/)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
    ...
    specify('the URL must not contain any spaces', () => {
      expect(Up.parseDocument('[SPOILER: yeah] (ign.com had some hilarious forums)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('yeah')
          ]),
    ...
    specify('the domain part must not be escaped', () => {
      expect(Up.parseDocument('[SPOILER: yeah] (\\ign.com)')).to.deep.equal(
        insideDocumentAndParagraph([
          new InlineSpoiler([
            new PlainText('yeah')
          ]),
  ...
  specify('If none of the conditions are satisfied, the spoiler is not linkified', () => {
    expect(Up.parseDocument('[SPOILER: something terrible] (really)')).to.deep.equal(
      insideDocumentAndParagraph([
        new InlineSpoiler([
          new PlainText('something terrible')
        ]),
...
describe('If there is nothing but whitspace between an inline spoiler and a bracketed URL, but one of the whitespace characters is escaped', () => {
  it('the spoiler convention is not linkified', () => {
    expect(Up.parseDocument('[SPOILER: something terrible]  \\  (https://example.com)')).to.deep.equal(
      insideDocumentAndParagraph([
        new InlineSpoiler([
          new PlainText('something terrible')
        ]),
