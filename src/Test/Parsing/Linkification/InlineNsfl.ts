...
describe('An inline NSFL convention followed immediately by a parenthesized/bracketd URL', () => {
  it('produces an inline NSFL node whose contents are put inside a link pointing to that URL', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFL: you eat rotting Gary](http://example.com/finalbattle).')).to.deep.equal(
...
describe('An inline NSFL convention directly followed by another NSFL convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFL: you eat rotting Gary][NSFL: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfl([
          new PlainText('you eat rotting Gary')
...
describe('An inline NSFL convention directly followed by an inline spoiler convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFL: you eat rotting Gary][SPOILER: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfl([
          new PlainText('you eat rotting Gary')
...
describe('An inline NSFL convention directly followed by an inline NSFW convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFL: you eat rotting Gary][NSFW: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfl([
          new PlainText('you eat rotting Gary')
...
describe('An inline NSFL convention directly followed by a media convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFL: you eat rotting Gary][audio: final battle theme](https://example.com/songs/123.ogg)')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfl([
          new PlainText('you eat rotting Gary')
...
describe('An otherwise-valid linkified NSFL convention with its URL escaped', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('[NSFL: he called her](\\tel:5555555555)')).to.deep.equal(
      insideDocumentAndParagraph([
        new InlineNsfl([
