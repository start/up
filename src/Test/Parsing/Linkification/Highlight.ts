...
describe('A highlight followed immediately by a parenthesized/bracketd URL', () => {
  it('produces a highlight node whose contents are put inside a link pointing to that URL', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [highlight: you fight Gary](http://example.com/finalbattle).')).to.deep.equal(
...
describe('A highlight directly followed by another highlight', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [highlight: you fight Gary][highlight: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new Highlight([
          new PlainText('you fight Gary')
...
describe('A highlight directly followed by an inline NSFW convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [highlight: you fight Gary][NSFW: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new Highlight([
          new PlainText('you fight Gary')
...
describe('A highlight directly followed by an inline NSFL convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [highlight: you fight Gary][NSFL: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new Highlight([
          new PlainText('you fight Gary')
...
describe('A highlight directly followed by a media convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [highlight: you fight Gary][audio: final battle theme](https://example.com/songs/123.ogg)')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new Highlight([
          new PlainText('you fight Gary')
...
describe('An otherwise-valid linkified highlight with its URL escaped', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('[highlight: he called her](\\tel:5555555555)')).to.deep.equal(
      insideDocumentAndParagraph([
        new Highlight([
