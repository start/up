...
describe('An inline NSFW convention followed immediately by a parenthesized/bracketd URL', () => {
  it('produces an inline NSFW node whose contents are put inside a link pointing to that URL', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFW: you wrestle naked Gary](http://example.com/finalbattle).')).to.deep.equal(
...
describe('An inline NSFW convention directly followed by another NSFW convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFW: you wrestle naked Gary][NSFW: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfw([
          new PlainText('you wrestle naked Gary')
...
describe('An inline NSFW convention directly followed by an inline spoiler convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFW: you wrestle naked Gary][SPOILER: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfw([
          new PlainText('you wrestle naked Gary')
...
describe('An inline NSFW convention directly followed by an inline NSFL convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFW: you wrestle naked Gary][NSFL: and win].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfw([
          new PlainText('you wrestle naked Gary')
...
describe('An inline NSFW convention directly followed by a media convention', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('After you beat the Elite Four, [NSFW: you wrestle naked Gary][audio: final battle theme](https://example.com/songs/123.ogg)')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfw([
          new PlainText('you wrestle naked Gary')
...
describe('An otherwise-valid linkified NSFW convention with its URL escaped', () => {
  it('is not linkified', () => {
    expect(Up.parseDocument('[NSFW: he called her](\\tel:5555555555)')).to.deep.equal(
      insideDocumentAndParagraph([
        new InlineNsfw([
