...
describe('A typical line of text', () => {
  it('produces a paragraph node', () => {
    expect(Up.parseDocument("I'm just a normal guy who only eats when it's raining. Also, it has to be around 70 degrees.")).to.deep.equal(
...
describe('A paragraph', () => {
  it('can contain inline conventions', () => {
    expect(Up.parseDocument("I'm just a normal guy who only eats when it's raining. Isn't *everyone* like that?")).to.deep.equal(
      insideDocumentAndParagraph([
