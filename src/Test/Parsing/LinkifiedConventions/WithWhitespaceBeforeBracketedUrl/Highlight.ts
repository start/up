...
context('A linkified highlight can have whitespace between itself and its bracketed URL, but only if the URL satisfies one of the following conditions:', () => {
  ...
  context('When the URL has a scheme', () => {
    ...
    specify('the URL must not contain any spaces', () => {
      expect(Up.toDocument('[highlight: something terrible] (https://stackoverflow.com is nice)')).to.deep.equal(
    ...
    specify('there must be somethng after the scheme', () => {
      expect(Up.toDocument('[highlight: email] (mailto:)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('email')
          ]),
    ...
    specify('there must be somethng after the scheme beyond only slashes', () => {
      expect(Up.toDocument('[highlight: local files] (file:///)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
    ...
    specify('the scheme must not be escaped', () => {
      expect(Up.toDocument('[highlight: email] (\\mailto:daniel@wants.email)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('email')
          ]),
  ...
  describe('When the URL starts with a slash, the URL', () => {
    it('must not contain any spaces', () => {
      expect(Up.toDocument('[highlight: something terrible] (/r9k/ created it)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('something terrible')
          ]),
    ...
    it('must have something after the slash', () => {
      expect(Up.toDocument('[highlight: slash] (/)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('slash')
          ]),
    ...
    it('must not have its slash escaped', () => {
      expect(Up.toDocument('[highlight: yeah] (\\/r9k/)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('yeah')
          ]),
  ...
  describe('When the URL starts with a hash mark ("#"), the URL', () => {
    ...
    it('must have something after the hash mark', () => {
      expect(Up.toDocument('[highlight: hash mark] (#)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
    ...
    it('must not contain any spaces', () => {
      expect(Up.toDocument('[highlight: something terrible] (#starcraft2 was never trending)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('something terrible')
          ]),
    ...
    it('must not have its hashmark escaped', () => {
      expect(Up.toDocument('[highlight: yeah] (\\#starcraft2)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('yeah')
          ]),
  ...
  describe('When the URL merely has a top-level domain', () => {
    ...
    specify('the top-level domain may not be followed by any character other than a forward slash', () => {
      expect(Up.toDocument('[highlight: that place] (4chan.org-terrifying)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
    ...
    context('The top-level domain must contain only letters', () => {
      specify('No numbers', () => {
        expect(Up.toDocument('[highlight: username] (john.e.smith5)')).to.deep.equal(
          insideDocumentAndParagraph([
            new Highlight([
      ...
      specify('No hyphens', () => {
        expect(Up.toDocument('[highlight: username] (john.e.smith-kline)')).to.deep.equal(
          insideDocumentAndParagraph([
            new Highlight([
              new PlainText('username')
            ]),
    ...
    specify('the URL must start with a letter or a number, not a period', () => {
      expect(Up.toDocument('[highlight: top-level domain] (.co.uk)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
    ...
    specify('the URL must not have consecutive periods before the top-level domain', () => {
      expect(Up.toDocument('[highlight: Ash is not his own father] (um..uh)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
    ...
    specify('the URL must not have consecutive periods directly after the top-level domain before the slash that indicates the start of the resource path', () => {
      expect(Up.toDocument('[highlight: debilitating sadness] (4chan.org../r9k/)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
    ...
    specify('the URL must not contain any spaces', () => {
      expect(Up.toDocument('[highlight: yeah] (ign.com had some hilarious forums)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('yeah')
          ]),
    ...
    specify('the domain part must not be escaped', () => {
      expect(Up.toDocument('[highlight: yeah] (\\ign.com)')).to.deep.equal(
        insideDocumentAndParagraph([
          new Highlight([
            new PlainText('yeah')
          ]),
  ...
  specify('If none of the conditions are satisfied, the highlight is not linkified', () => {
    expect(Up.toDocument('[highlight: something terrible] (really)')).to.deep.equal(
      insideDocumentAndParagraph([
        new Highlight([
          new PlainText('something terrible')
        ]),
...
describe('If there is nothing but whitspace between a highlight and a bracketed URL, but one of the whitespace characters is escaped', () => {
  it('the highlight is not linkified', () => {
    expect(Up.toDocument('[highlight: something terrible]  \\  (https://example.com)')).to.deep.equal(
      insideDocumentAndParagraph([
        new Highlight([
          new PlainText('something terrible')
        ]),
