...
describe('Square bracketed text starting with "NSFW:"', () => {
  it('is put inside an inline NSFL node', () => {
    expect(Up.toDocument('After you beat the Elite Four, [NSFL: you eat a rotting Gary].')).to.deep.equal(
...
describe('An NSFL convention', () => {
  ...
  it('is evaluated for other conventions', () => {
    expect(Up.toDocument('After you beat the Elite Four, [NSFL: you eat [image: rotting Gary](https://example.com/ummmm.png)].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfl([
  ...
  it('can be nested within another NSFL convention', () => {
    expect(Up.toDocument('After you beat the Elite Four, [NSFL: you eat [NSFL: a rotting Gary]].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfl([
          new PlainText('you eat '),
...
describe('An inline NSFL convention produced by square brackets', () => {
  it('can contain square bracketed text', () => {
    expect(Up.toDocument('After you beat the Elite Four, [NSFL: you eat [and finish] a rotting Gary].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfl([
          new PlainText('you eat '),
...
describe('Any whitespace between "NSFL:" and the start of the NSFL content', () => {
  it('is optional', () => {
    expect(Up.toDocument('After you beat the Elite Four, [NSFL:you wrestle a rotten Gary].')).to.deep.equal(
      insideDocumentAndParagraph([
        new PlainText('After you beat the Elite Four, '),
        new InlineNsfl([
