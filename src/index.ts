...
export { Italics } from './SyntaxNodes/Italics'
...
export { InlineRevealableContent } from './SyntaxNodes/InlineRevealableContent'
export { OutlineRevealableContent } from './SyntaxNodes/OutlineRevealableContent'
