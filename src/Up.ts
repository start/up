...
export class Up {
  ...
  // Converts Up markup into HTML, then returns the result.
  ...
  // Converts inline Up markup into inline HTML, then returns the result.
  ...
  // Converts an inline syntax tree into inline HTML, then results the result.
