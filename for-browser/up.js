...
},{"../../SyntaxNodes/AudioNode":41,"../../SyntaxNodes/ImageNode":53,"../../SyntaxNodes/VideoNode":77,"./Tokenization/TokenKind":11}],3:[function(require,module,exports){
"use strict";
...
},{"../../SyntaxNodes/ActionNode":40,"../../SyntaxNodes/EmphasisNode":49,"../../SyntaxNodes/FootnoteNode":51,"../../SyntaxNodes/LinkNode":58,"../../SyntaxNodes/NsflNode":60,"../../SyntaxNodes/NsfwNode":61,"../../SyntaxNodes/ParenthesizedNode":66,"../../SyntaxNodes/RevisionDeletionNode":68,"../../SyntaxNodes/RevisionInsertionNode":69,"../../SyntaxNodes/SpoilerNode":72,"../../SyntaxNodes/SquareBracketedNode":73,"../../SyntaxNodes/StressNode":74,"./Tokenization/TokenKind":11}],4:[function(require,module,exports){
"use strict";
...
var Tokenizer = (function () {
    function Tokenizer(entireText, config) {
        ...
        this.nakedUrlConvention = {
            ...
            whenOpening: function (urlScheme) {
                _this.appendNewToken({ kind: TokenKind_1.TokenKind.NakedUrlSchemeAndStart, value: urlScheme });
            },
            insteadOfOpeningUsualConventionsWhileOpen: function () { return _this.bufferRawText(); },
            whenClosingItFlushesBufferTo: TokenKind_1.TokenKind.NakedUrlAfterSchemeAndEnd,
    ...
    Tokenizer.prototype.configureConventions = function () {
        ...
        this.conventions.push({
            ...
            flushesBufferToPlainTextTokenBeforeOpening: true,
            insteadOfClosingOuterConventionsWhileOpen: function () { return _this.bufferCurrentChar(); },
    ...
    Tokenizer.prototype.tryToCollectEscapedChar = function () {
        if (this.consumer.currentChar === Strings_1.ESCAPER_CHAR) {
    ...
    Tokenizer.prototype.shouldBacktrackToBeforeContext = function (context) {
        return (context.convention.failsIfWhitespaceIsEnounteredBeforeClosing
    ...
    Tokenizer.prototype.tryToTransformConvention = function (args) {
        ...
        var couldTransform = context.convention.whenClosingItFailsIfItCannotTranformInto.some(function (convention) { return _this.tryToOpen(convention); });
        if (!couldTransform) {
    ...
    Tokenizer.prototype.tryToOpen = function (convention) {
        var _this = this;
        var startPattern = convention.startPattern, flushesBufferToPlainTextTokenBeforeOpening = convention.flushesBufferToPlainTextTokenBeforeOpening, whenOpening = convention.whenOpening;
        return (this.canTry(convention)
            && this.consumer.consume({
                ...
                thenBeforeAdvancingTextIndex: function (match, matchPrecedesNonWhitespace) {
                    ...
                    if (whenOpening) {
                        whenOpening.apply(void 0, [match, matchPrecedesNonWhitespace].concat(captures));
                    }
                }
            }));
    };
    ...
    Tokenizer.prototype.canTry = function (convention, textIndex) {
        ...
        var conventionsThisOneTransformTo = convention.whenClosingItFailsIfItCannotTranformInto;
        var hasAlreadyFailedAfterTransitioning = conventionsThisOneTransformTo
    ...
    Tokenizer.prototype.getLinkUrlSeparatedByWhitespaceConventions = function () {
        ...
        return BRACKETS.map(function (bracket) { return ({
            ...
            insteadOfClosingOuterConventionsWhileOpen: function () { _this.bufferRawText(); },
            whenClosingItAlsoClosesInnerConventions: true,
    ...
    Tokenizer.prototype.getRichSandwichConvention = function (args) {
        ...
        return {
            ...
            flushesBufferToPlainTextTokenBeforeOpening: true,
            whenClosingItFlushesBufferTo: TokenKind_1.TokenKind.PlainText,
            whenClosing: function (context) {
    ...
    Tokenizer.prototype.getMediaDescriptionConventions = function () {
        ...
        return CollectionHelpers_1.concat([MediaConventions_1.IMAGE_CONVENTION, MediaConventions_1.VIDEO_CONVENTION, MediaConventions_1.AUDIO_CONVENTION].map(function (media) {
            return BRACKETS.map(function (bracket) { return ({
                ...
                insteadOfClosingOuterConventionsWhileOpen: function () { return _this.bufferRawText(); },
                whenClosingItAlsoClosesInnerConventions: true,
                whenClosingItFailsIfItCannotTranformInto: _this.mediaUrlConventions,
    ...
    Tokenizer.prototype.getRawBracketConventions = function () {
        ...
        return BRACKETS.map(function (bracket) { return ({
            startPattern: PatternHelpers_1.regExpStartingWith(bracket.startPattern),
            endPattern: PatternHelpers_1.regExpStartingWith(bracket.endPattern),
            whenOpening: function () { _this.buffer += bracket.start; },
            whenClosing: function () { _this.buffer += bracket.end; },
...
var FORWARD_SLASH = '/';
var HASH_MARK = '#';
var SUBDOMAIN = PatternHelpers_1.anyCharMatching(PatternPieces_1.LETTER_CLASS, PatternPieces_1.DIGIT_CLASS)
    + PatternHelpers_1.everyOptional(PatternHelpers_1.anyCharMatching(PatternPieces_1.LETTER_CLASS, PatternPieces_1.DIGIT_CLASS, PatternHelpers_1.escapeForRegex('-')));
var TOP_LEVEL_DOMAIN = PatternHelpers_1.atLeast(1, PatternPieces_1.LETTER_CHAR);
var DOMAIN_PART_WITH_TOP_LEVEL_DOMAIN = PatternHelpers_1.atLeast(1, SUBDOMAIN + PatternHelpers_1.escapeForRegex('.')) + TOP_LEVEL_DOMAIN;
...
var CONTENT_THAT_CANNOT_OPEN_OR_CLOSE_ANY_CONVENTIONS_PATTERN = PatternHelpers_1.regExpStartingWith(PatternHelpers_1.atLeast(1, PatternHelpers_1.either(PatternHelpers_1.anyCharNotMatching.apply(void 0, CHAR_CLASSES_THAT_CAN_OPEN_OR_CLOSE_CONVENTIONS), 'h' + PatternHelpers_1.notFollowedBy('ttp' + PatternHelpers_1.optional('s') + '://'))));
var WHITESPACE_THAT_NORMALLY_CANNOT_OPEN_OR_CLOSE_ANY_CONVENTIONS_PATTERN = PatternHelpers_1.regExpStartingWith(PatternPieces_1.SOME_WHITESPACE + PatternHelpers_1.notFollowedBy(PatternHelpers_1.anyCharMatching.apply(void 0, BRACKET_START_PATTERNS.concat(PatternPieces_1.WHITESPACE_CHAR))));

},{"../../../CollectionHelpers":1,"../../PatternHelpers":33,"../../PatternPieces":34,"../../Strings":36,"../MediaConventions":2,"../RichConventions":3,"./Bracket":4,"./ConventionContext":5,"./FailedConventionTracker":6,"./InlineTextConsumer":7,"./RaisedVoiceHandler":8,"./Token":10,"./TokenKind":11,"./TokenizerSnapshot":12,"./insertBracketsInsideBracketedConventions":13,"./nestOverlappingConventions":14}],16:[function(require,module,exports){
"use strict";
...
},{"../../CollectionHelpers":1,"../../SyntaxNodes/InlineCodeNode":54,"../../SyntaxNodes/LinkNode":58,"../../SyntaxNodes/PlainTextNode":67,"../isWhitespace":38,"./MediaConventions":2,"./RichConventions":3,"./Tokenization/TokenKind":11}],18:[function(require,module,exports){
"use strict";
...
var LEADING_BLANK_LINES_PATTERN = PatternHelpers_1.regExpStartingWith(PatternPieces_1.ANY_WHITESPACE + Strings_1.INPUT_LINE_BREAK);
var TRAILIN_BLANK_LINES_PATTERN = PatternHelpers_1.regExpEndingWith(Strings_1.INPUT_LINE_BREAK + PatternPieces_1.ANY_WHITESPACE);

},{"../../CollectionHelpers":1,"../../SyntaxNodes/SectionSeparatorNode":71,"../PatternHelpers":33,"../PatternPieces":34,"../Strings":36,"./LineConsumer":19,"./parseRegularLines":24,"./tryToParseBlankLineSeparation":25,"./tryToParseBlockquote":26,"./tryToParseCodeBlock":27,"./tryToParseDescriptionList":28,"./tryToParseHeading":29,"./tryToParseOrderedList":30,"./tryToParseSectionSeparatorStreak":31,"./tryToParseUnorderedList":32}],21:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
var Patterns_1 = require('../Patterns');
...
},{"../../SyntaxNodes/Line":56,"../../SyntaxNodes/LineBlockNode":57,"../../SyntaxNodes/MediaSyntaxNode":59,"../../SyntaxNodes/ParagraphNode":65,"../Inline/getInlineNodes":16,"../Patterns":35,"../isWhitespace":38,"./LineConsumer":19,"./isLineFancyOutlineConvention":23}],25:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
var SectionSeparatorNode_1 = require('../../SyntaxNodes/SectionSeparatorNode');
var Patterns_1 = require('../Patterns');
...
},{"../../SyntaxNodes/SectionSeparatorNode":71,"../Patterns":35,"./LineConsumer":19}],26:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
...
function tryToParseBlockquote(args) {
    ...
    var rawBlockquotedContent = rawBlockquoteLines.join(Strings_1.INPUT_LINE_BREAK);
    var headingLeveler = new HeadingLeveler_1.HeadingLeveler();
    var blockquote = new BlockquoteNode_1.BlockquoteNode(getOutlineNodes_1.getOutlineNodes(rawBlockquotedContent, headingLeveler, args.config));
...
},{"../../SyntaxNodes/BlockquoteNode":42,"../PatternHelpers":33,"../PatternPieces":34,"../Strings":36,"./HeadingLeveler":18,"./LineConsumer":19,"./getOutlineNodes":20}],27:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
...
function tryToParseCodeBlock(args) {
    ...
    while (!consumer.reachedEndOfText()) {
        if (consumer.consume({ linePattern: CODE_FENCE_PATTERN })) {
            var codeBlock = new CodeBlockNode_1.CodeBlockNode(codeLines.join(Strings_1.OUTPUT_LINE_BREAK));
...
},{"../../SyntaxNodes/CodeBlockNode":43,"../PatternHelpers":33,"../Strings":36,"./LineConsumer":19}],28:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
...
function tryToParseDescriptionList(args) {
    ...
    var _loop_1 = function() {
        ...
        var description = new Description_1.Description(getOutlineNodes_1.getOutlineNodes(rawDescriptionLines.join(Strings_1.INPUT_LINE_BREAK), args.headingLeveler, args.config));
...
},{"../../SyntaxNodes/Description":44,"../../SyntaxNodes/DescriptionListItem":45,"../../SyntaxNodes/DescriptionListNode":46,"../../SyntaxNodes/DescriptionTerm":47,"../Inline/getInlineNodes":16,"../Patterns":35,"../Strings":36,"./LineConsumer":19,"./getOutlineNodes":20,"./getRemainingLinesOfListItem":21,"./isLineFancyOutlineConvention":23}],29:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
...
},{"../../SyntaxNodes/HeadingNode":52,"../Inline/getInlineNodes":16,"../Patterns":35,"./LineConsumer":19,"./getSortedUnderlineChars":22,"./isLineFancyOutlineConvention":23}],30:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
...
var RawListItem = (function () {
    ...
    RawListItem.prototype.content = function () {
        return this.lines.join(Strings_1.INPUT_LINE_BREAK);
    };
    return RawListItem;
}());
...
var BULLET = PatternHelpers_1.either('#', PatternHelpers_1.capture(PatternHelpers_1.either(PatternPieces_1.INTEGER, '#') + PatternHelpers_1.anyCharFrom('.', ')')));
...
},{"../../SyntaxNodes/OrderedListItem":62,"../../SyntaxNodes/OrderedListNode":63,"../PatternHelpers":33,"../PatternPieces":34,"../Patterns":35,"../Strings":36,"./LineConsumer":19,"./getOutlineNodes":20,"./getRemainingLinesOfListItem":21}],31:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
var SectionSeparatorNode_1 = require('../../SyntaxNodes/SectionSeparatorNode');
var Patterns_1 = require('../Patterns');
...
},{"../../SyntaxNodes/SectionSeparatorNode":71,"../Patterns":35,"./LineConsumer":19}],32:[function(require,module,exports){
"use strict";
var LineConsumer_1 = require('./LineConsumer');
...
function tryToParseUnorderedList(args) {
    ...
    var _loop_1 = function() {
        ...
        rawListItemsContents.push(rawListItemLines.join(Strings_1.INPUT_LINE_BREAK));
        if (isListTerminated) {
            return "break";
        }
    };
...
var BULLET_PATTERN = PatternHelpers_1.regExpStartingWith(PatternHelpers_1.optional(' ') + PatternHelpers_1.anyCharFrom('*', '-', '+', '•') + PatternPieces_1.INLINE_WHITESPACE_CHAR);

},{"../../SyntaxNodes/UnorderedListItem":75,"../../SyntaxNodes/UnorderedListNode":76,"../PatternHelpers":33,"../PatternPieces":34,"../Patterns":35,"../Strings":36,"./LineConsumer":19,"./getOutlineNodes":20,"./getRemainingLinesOfListItem":21}],33:[function(require,module,exports){
"use strict";
...
var DIVIDER_STREAK_CHAR = PatternHelpers_1.anyCharFrom('#', '=', '-', '+', '~', '*', '^', '@', ':', '_');
...
},{"../CollectionHelpers":1,"../SyntaxNodes/BlockquoteNode":42,"../SyntaxNodes/DescriptionListNode":46,"../SyntaxNodes/FootnoteBlockNode":50,"../SyntaxNodes/FootnoteNode":51,"../SyntaxNodes/HeadingNode":52,"../SyntaxNodes/LineBlockNode":57,"../SyntaxNodes/OrderedListNode":63,"../SyntaxNodes/ParagraphNode":65,"../SyntaxNodes/UnorderedListNode":76}],38:[function(require,module,exports){
"use strict";
var PlainTextNode_1 = require('../SyntaxNodes/PlainTextNode');
var Patterns_1 = require('./Patterns');
...
},{"../SyntaxNodes/PlainTextNode":67,"./Patterns":35}],39:[function(require,module,exports){
"use strict";
...
},{"../SyntaxNodes/DocumentNode":48,"./Outline/HeadingLeveler":18,"./Outline/getOutlineNodes":20,"./handleFootnotes":37}],40:[function(require,module,exports){
"use strict";
...
},{"./RichInlineSyntaxNode":70}],41:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./MediaSyntaxNode":59}],42:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./OutlineSyntaxNode":64}],43:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./OutlineSyntaxNode":64}],44:[function(require,module,exports){
"use strict";
...
},{"./OutlineSyntaxNode":64}],47:[function(require,module,exports){
"use strict";
...
},{"./RichInlineSyntaxNode":70}],50:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./OutlineSyntaxNode":64}],51:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],52:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./OutlineSyntaxNode":64}],53:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./MediaSyntaxNode":59}],54:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./InlineSyntaxNode":55}],55:[function(require,module,exports){
"use strict";
...
},{"./OutlineSyntaxNode":64}],58:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],59:[function(require,module,exports){
"use strict";
...
},{"./RichInlineSyntaxNode":70}],61:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],62:[function(require,module,exports){
"use strict";
...
},{"./OutlineSyntaxNode":64}],64:[function(require,module,exports){
"use strict";
...
},{"./OutlineSyntaxNode":64}],66:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],67:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./InlineSyntaxNode":55}],68:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],69:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],70:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../SyntaxNodes/InlineSyntaxNode":55}],71:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./OutlineSyntaxNode":64}],72:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],73:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],74:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./RichInlineSyntaxNode":70}],75:[function(require,module,exports){
"use strict";
...
},{"./OutlineSyntaxNode":64}],77:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./MediaSyntaxNode":59}],78:[function(require,module,exports){
"use strict";
...
},{"./Parsing/parseDocument":39,"./UpConfig":79,"./Writers//Html/HtmlWriter":81}],79:[function(require,module,exports){
"use strict";
...
},{"../../SyntaxNodes/LinkNode":58,"../../SyntaxNodes/OrderedListNode":63,"../../SyntaxNodes/PlainTextNode":67,".././Writer":83,"./EscapingHelpers":80,"./WritingHelpers":82}],82:[function(require,module,exports){
"use strict";
var EscapingHelpers_1 = require('./EscapingHelpers');
...
},{"./EscapingHelpers":80}],83:[function(require,module,exports){
"use strict";
var LinkNode_1 = require('../SyntaxNodes/LinkNode');
var ImageNode_1 = require('../SyntaxNodes/ImageNode');
var AudioNode_1 = require('../SyntaxNodes/AudioNode');
...
},{"../SyntaxNodes/ActionNode":40,"../SyntaxNodes/AudioNode":41,"../SyntaxNodes/BlockquoteNode":42,"../SyntaxNodes/CodeBlockNode":43,"../SyntaxNodes/DescriptionListNode":46,"../SyntaxNodes/DocumentNode":48,"../SyntaxNodes/EmphasisNode":49,"../SyntaxNodes/FootnoteBlockNode":50,"../SyntaxNodes/FootnoteNode":51,"../SyntaxNodes/HeadingNode":52,"../SyntaxNodes/ImageNode":53,"../SyntaxNodes/InlineCodeNode":54,"../SyntaxNodes/LineBlockNode":57,"../SyntaxNodes/LinkNode":58,"../SyntaxNodes/NsflNode":60,"../SyntaxNodes/NsfwNode":61,"../SyntaxNodes/OrderedListNode":63,"../SyntaxNodes/ParagraphNode":65,"../SyntaxNodes/ParenthesizedNode":66,"../SyntaxNodes/PlainTextNode":67,"../SyntaxNodes/RevisionDeletionNode":68,"../SyntaxNodes/RevisionInsertionNode":69,"../SyntaxNodes/SectionSeparatorNode":71,"../SyntaxNodes/SpoilerNode":72,"../SyntaxNodes/SquareBracketedNode":73,"../SyntaxNodes/StressNode":74,"../SyntaxNodes/UnorderedListNode":76,"../SyntaxNodes/VideoNode":77}],84:[function(require,module,exports){
"use strict";
